<!DOCTYPE html>
	...
	<head>
		...
		<!-- PAGE TITLE HERE -->
		<title>Trip-Track | Edit Data Perjalanan</title>
        ...
        <div class="card-body">
            <div class="basic-form">
                <form class="form-valide-with-icon needs-validation" novalidate="">
                    <div class="mb-3">
                        <label class="text-label form-label" for="validationCustomUsername">No</label>
                        <div class="input-group">
                            <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                            <input type="text" class="form-control" id="validationCustomNo" placeholder="Masukan No Anda.." required="">
                    ...
                    <div class="mb-3">
                        <label class="text-label form-label" for="validationCustomUsername">Nama User *</label>
                        <div class="input-group transparent-append">
                            <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                            <input type="username" class="form-control" id="dlab-username" placeholder="Masukan username Anda.." required="">
                            <div class="invalid-feedback">
                                Please Enter a No.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <label class="text-label form-label" for="dlab-date">Tanggal *</label>
                        <div class="input-group transparent-append">
                            <span class="input-group-date"> <i class="fa fa-date"></i> </span>
                            <input type="tanggal" class="form-control" id="dlab-date" placeholder="Choose a safe one.." required="">
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        <label class="text-label form-label" for="dlab-password">jam *</label>
                        <div class="input-group transparent-append">
                            <span class="input-group-text"> <i class=""></i> </span>
                            <input type="jam" class="form-control" id="dlab-jam" placeholder="Choose a safe one.." required="">
                            <div class="invalid-feedback">
                                Please Enter a username.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <label class="text-label form-label" for="dlab-password">lokasi *</label>
                        <div class="input-group transparent-append">
                            <span class="input-group-text"> <i class=""></i> </span>
                            <input type="lokasi" class="form-control" id="dlab-lokasi" placeholder="Choose a safe one.." required="">
                            <div class="invalid-feedback">
                                Please Enter a username.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <label class="text-label form-label" for="dlab-password">suhu *</label>
                        <div class="input-group transparent-append">
                            <span class="input-group-text"> <i class=""></i> </span>
                            <input type="suhu" class="form-control" id="dlab-suhu" placeholder="Choose a safe one.." required="">
                            <div class="invalid-feedback">
                                Please Enter a username.
                            </div>
                        </div>
