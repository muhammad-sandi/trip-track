            ...
            <div class="col-xl-3 col-xxl-4 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex justify-content-evenly">
                        ...
                        <div>
                            {{-- <h2 class="text-white invoice-num">Catatan Perjalanan</h2> --}}
                            <p class="text-white" style="font-size: 20px;">Data Perjalanan</p>
                            <div class="btn btn-dark fw-bold float-end" href="">
                                View
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <p class="text-white" style="font-size: 20px;">Tambah Perjalanan</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="bottom top d-flex justify-content-around">
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <p class="text-white" style="font-size: 20px;">Data User</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <p class="text-white" style="font-size: 20px;">Tambah user</p>
                        </div>
                    </div>
                </div>
            </div>
